  ...
  const researchAreas: ResearchCard[] = [
    {
      ...
      description:
        "Developing next-generation hydrogen fuel cell systems for zero-emission vehicles with improved efficiency and durability.",
    },
    {
  ...
  return (
    <section id="research" className="py-20 px-4 sm:px-6 lg:px-8 bg-card">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-4xl sm:text-5xl font-bold text-foreground mb-4 text-center">What I'm Working On</h2>
